...
\texttt{download\_soccernet.py} & Downloads SoccerNet event annotation files. \\
\texttt{download\_videos.py} & Downloads 720p match video files from SoccerNet. \\
\texttt{scan\_offsides.py} & Displays a summary of available offside events and download status. \\
...
\hline
Python & 3.11 \\
ultralytics (YOLO11x-seg) & 8.3.x \\
OpenCV (\texttt{opencv-python}) & 4.9.x \\
scikit-learn & 1.4.x \\
NumPy & 1.26.x \\
FFmpeg & 6.x \\
