...
All pipeline inputs and outputs are stored under \texttt{data/}. The full project directory, including all generated output images and data files, is available at the following link:

\begin{center}
\url{https://drive.google.com/drive/folders/1rl4i2wWuiIrOIdIEQbCH8oklGCEX9Vm4?usp=sharing}
\end{center}

The table below describes the contents of each subdirectory.
